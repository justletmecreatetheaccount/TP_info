...
class TestXYRobot(unittest.TestCase):
    ...
    def test_position_x(self):
        test_bot = TurtleBot("test_bot", 69)
        self.assertEqual(test_bot.x(), 69)

    def test_position_y(self):
        test_bot = TurtleBot("test_bot", 0, 69)
        self.assertEqual(test_bot.y(), 69)

    def test_movement(self):
        test_bot = TurtleBot("test_bot", 100, 100)
    ...
    def test_history(self):
        ...
        test_bot.turn_right()
        test_bot.move_backward(69)
        self.assertEqual(test_bot.history(), [('forward', 69), ('right', 90), ('backward', 69)])
