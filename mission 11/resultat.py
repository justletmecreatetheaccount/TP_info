...
class Resultat :
    ...
    def __eq__(self, autre):
        ...
        @post: Retourne True si le temps de ce résultat (self) est égale
    ...
    def __ge__(self, autre):
        ...
        paramètre, sur base de leur temps.
        @pre:  autre est une autre instance valide de la classe Resultat
        @post: Retourne True si ce temps de ce résultat (self) est plus
